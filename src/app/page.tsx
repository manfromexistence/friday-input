...
export default function HomePage() {
  return (
    <>
      {/* 
        The HueAnimatedTextarea and FluidSimulation might visually conflict 
        when Friday is active, as Friday tries to control viewport edges.
        Consider commenting out one or the other for focused testing.
      */}
      {/* <HueAnimatedTextarea /> */}
      {/* <FluidSimulation /> */}
      
      <Friday /> {/* Add Friday component here */}

      {/* Example content to see if Friday overlays it */}
      ...
      {/* Styles for HueAnimatedTextarea if uncommented */}
      {/* Make sure to include its styles if you use it */}
      <style jsx global>{`
          /* Styles for Hue Animated Textarea (if active) */
          /* ... (original styles for glowing-textarea-wrapper, etc.) ... */
          /* NOTE: The original styles for HueAnimatedTextarea were moved here.
             If you uncomment HueAnimatedTextarea, ensure these are present.
             For brevity in this change, I'm assuming they are or will be managed.
          */
